...
#Train_accuracy,test_accuracy=p1.classifier_accuracy(p1.pegasos, train_bow_features,test_bow_features,train_labels,test_labels,T=25,L=0.0100)
#print('Prasanna best = {:.4f}, L={:.4f}'.format(test_accuracy, Ls[np.argmax(peg_tune_results_L[1])]))
#print('Prasanna',test_accuracy)
...
peg_tune_results_L = utils.tune_pegasos_L(25, Ls, *data)
print(peg_tune_results_L)
...
#T=25
#L=0.0100
#theta,theta0=p1.pegasos(train_bow_features,train_labels,T,L)
